...
# print("제 나이는 %s 입니다." % age) #모든 문자를 문자열로 포맷팀해서 출력
# print("제 나이는 %d 입니다." % age) #모든 문자를 정수형로 포맷팀해서 출력
# print("제 이름은 %s 이고, 제 나이는 %d 입니다." % (name, age))
# print("Loading...%d%% " % 98)
# print("%10s" % "hi") #문자열 포함 길이(문자열 앞에 공백 포함)
# print("%-10s" % "heiio") #문자열 포함 길이(문자열 뒤에 공백 포함)
# print("%0.4f" % 3.422134) #앞에 0은 자리수를 의미, .4는 소수점 4번쨰 자리까지 표현
# print("%10.4f" % 3.422134)
#10은 자리수를 의미하므로 소수점 4번째 자리까지 표현 후 남는 자리만큼 앞에 공백
